...
> **Sample on GitHub** · `USDJPY_1m.csv` (55,440 rows, `2026-07-09` -> `2026-09-02`, 5.32 MB). **Full archive on [getdata.finance](https://getdata.finance/datasets/usdjpy)** — **9,209,554** `1m` rows, **11 timeframes**, `2001-11-28` -> `2026-09-02`.
...
df = pd.read_csv('USDJPY_1m.csv', parse_dates=['time'])
